...
void display(void)
{
	...
	glm::mat4 modelTemp = glm::mat4(1.0f); //Matriz temporal de traslaciones
	...
	//Cabeza
	modelTemp = model;
	modelTemp = glm::scale(modelTemp, glm::vec3(1.5, 2.5, 0.5));
	...
	modelTemp = model;
	modelTemp = glm::scale(modelTemp, glm::vec3(0.5, 0.5, 0.5));
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.3f, 0.5f));
	projectionShader.setMat4("model", modelTemp);
	glDrawArrays(GL_QUADS, 0, 24);
	...
	modelTemp = model;
	modelTemp = glm::scale(modelTemp, glm::vec3(4, 5, 0.5));
	...
	modelTemp = model;
	modelTemp = glm::scale(modelTemp, glm::vec3(2, 1, 0.5));
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 1.0f, 0.4f));
	projectionShader.setMat4("model", modelTemp);
	glDrawArrays(GL_QUADS, 0, 24);
	...
	modelTemp = model;
	modelTemp = glm::scale(modelTemp, glm::vec3(0.5, 3, 0.5));
	projectionShader.setVec3("aColor", glm::vec3(0.6f, 0.0f, 1.0f));
	projectionShader.setMat4("model", modelTemp);
	glDrawArrays(GL_QUADS, 0, 24);
	...
	//Cintura
	model = glm::translate(model, glm::vec3(-3.75f, -3.5f, 0.0f));
	modelTemp = model;
	modelTemp = glm::scale(modelTemp, glm::vec3(4, 2, 0.5));
	...
	modelTemp = model;
	modelTemp = glm::scale(modelTemp, glm::vec3(1, 3, 0.5));
	...
	modelTemp = model;
	modelTemp = glm::scale(modelTemp, glm::vec3(4, 1, 0.5));
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.4f, 0.2f));
	projectionShader.setMat4("model", modelTemp);
	glDrawArrays(GL_QUADS, 0, 24);
